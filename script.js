...
function displayUsers(users) {
    ...
    tbody.innerHTML = users.map((u, i) => {
        ...
        return `<tr>
            ...
            <td style="font-size:12px;font-weight:700;color:var(--neon);max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="ID: ${u.device_id}">
                📱 ${u.device_name || u.device_id?.substring(0,12)+'...'}
            </td>
            <td style="font-size:10px;font-family:'JetBrains Mono',monospace;color:var(--muted);" title="${u.device_id}">${u.device_id?.substring(0,8)}...</td>
